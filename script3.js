...
function showWeatherReport(weather){
 ...
 }else if(weatherType.textContent == 'Thuderstorm'){
   document.body.style.backgroundImage = "url('Thuderstrom.jpeg')";}


}
function dateManage(dateArg){
 let days = ["Sunday","Monday","Tuesday","Wednesday","Thursday","Fridaya","Saturday"];
